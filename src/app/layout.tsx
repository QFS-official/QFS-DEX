...
export const metadata: Metadata = {
  title: "Portal Bridge — BNB · Polygon · Solana",
  description:
    "Cross-chain bridge for BNB Chain, Polygon, and Solana. Connect MetaMask or Coinbase Wallet to bridge USDC, USDT, ETH, and native gas tokens across chains.",
  keywords: ["Portal Bridge", "BNB Chain", "Polygon", "Solana", "cross-chain bridge", "MetaMask", "Coinbase Wallet"],
  ...
  openGraph: {
    title: "Portal Bridge — BNB · Polygon · Solana",
    description: "Cross-chain bridge for BNB Chain, Polygon, and Solana.",
    type: "website",
  },
  twitter: {
